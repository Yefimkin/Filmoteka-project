...
async function onClickFilm(e) {
    ...
    try {
        ...
        const { original_title, genres, runtime, popularity, vote_average, vote_count, poster_path, overview } = responceFilmID;
        ...
        const modalFilm = basicLightbox.create(`
            <div class="modal">
                ...
                <img src="${moviePoster}" alt="Poster for the movie" />
                </div>
                    ...
                    <div class="modal-post__info">
                        <table>
                            <tr class="tr">
                                ...
                                <td class="ti">
                                <span class="vote-value">${vote_average.toFixed(1)}</span>
                                /
                            ...
                            <tr class="tr">
                                ...
                                <td class="ti popularity-value">${popularity.toFixed(1)}</td>
                            </tr>
                            <tr class="tr">
                            ...
                            <tr class="tr">
                                ...
                                <td class="ti genre-value">${showGenres(genres)}</td>
                            </tr>
                        </table>
                    </div>
